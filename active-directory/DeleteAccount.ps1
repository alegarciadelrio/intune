...
Invoke-Command SERVER-NAME-W22 -Credential DOMAIN.CORP\Administrator { Start-ADSyncSyncCycle -PolicyType Delta }
...
Get-ADUser "z_archive.$name"| Move-ADObject -TargetPath 'OU=Archived Mailboxes,OU=Users,OU=SITE,DC=DOMAIN,DC=CORP'
